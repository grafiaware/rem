...
class IdentityNameHydratorMock_ForIdentityHydratorTest implements AccessorNameHydratorInterface {    
 ...
 * @author vlse2610
 */
class IdentityHydratorTest extends TestCase {
    /**
...
//        $this->testovaciRowObject->klic2 = 'bb';        
    ...
    public function testHydrate_KlicNeniGenerovany_SNameHydratorem() {    
        ...
        $this->testovaciKeyHash   = [ 'klic1|' => 'aa', 'klic2|' => 'bb'  ];     //ocekavany  v  identite         
