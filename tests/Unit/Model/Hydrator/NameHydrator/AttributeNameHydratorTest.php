<?php
namespace Test\RO_AttributeNameHydratorTest;
 ...
 * 
 */
class RO_AttributeNameHydratorTest extends TestCase {

    private  $testovanyCCStrings = [
        "testA",
        "janTamBylSam",
        "janVTomBylSam",
        "kadelJeJednicka",
...
//------------------------------------------------------------------------------------------------
   ...
   public function testHydrate() {       
         $nameHydrator = new AttributeNameHydrator();
//       foreach ($this->testovany_Strings as $key => $value) {
//            $this->testOut[$key] = $nameHydrator->hydrate($value);
//       } 
        
//        // ocekavana, aktualni
//        $this->assertEquals( "test_a", $nameHydrator->hydrate("test_a"), "-CHYBA-"  );
...
//        $this->assertEquals( "123PraZaci", $nameHydrator->hydrate("123_Pra_Zaci"), "-CHYBA-"  );
        ...
        $this->assertEquals( "test_a", $nameHydrator->hydrate("testA"), "-CHYBA-" );
        $this->assertEquals( "jan_tam_byl_sam",  $nameHydrator->hydrate("janTamBylSam"), "-CHYBA-" );
        $this->assertEquals( "jan_v_tom_byl_sam", $nameHydrator->hydrate("janVTomBylSam"), "-CHYBA-" );
        $this->assertEquals( "kadel_je_jednicka",  $nameHydrator->hydrate("kadelJeJednicka"), "-CHYBA-" );
        $this->assertEquals( "pred_cislem123celych", $nameHydrator->hydrate("predCislem123celych"), "-CHYBA-" );
        $this->assertEquals( "pred_cislem123_tisic",  $nameHydrator->hydrate("predCislem123Tisic"), "-CHYBA-" );
        $this->assertEquals( "nejdriv_male_potom_t_r_d_l_o",  $nameHydrator->hydrate("nejdrivMalePotomTRDLO"), "-CHYBA-" );        
        $this->assertEquals( "pra_zakladi_vseho", $nameHydrator->hydrate("praZakladiVseho"), "-CHYBA-" );
        $this->assertEquals( "pra0zak_ladi00_vseho", $nameHydrator->hydrate("pra0zakLadi00Vseho"), "-CHYBA-" );
        $this->assertEquals( "pra0_zak_lad3_v3eho3",  $nameHydrator->hydrate("pra0ZakLad3V3eho3"), "-CHYBA-" );
        $this->assertEquals( "123_pra_zaci", $nameHydrator->hydrate("123PraZaci"), "-CHYBA-" );
