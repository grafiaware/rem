...
use Model\Entity\Hydrator\OneToOneAccessorHydrator;

use Model\Entity\EntityAbstract;
use Model\Entity\Identity\IdentityInterface;
use Model\Entity\Hydrator\Filter\OneToOneFilterInterface;
use Model\Entity\Hydrator\NameHydrator\AccessorMethodNameHydratorInterface;
...
class MethodNameHydrator_forOOHT implements AccessorMethodNameHydratorInterface {    
...
interface EntityInterfaceMock_forOOHT extends AccesorInterface {       
 ...
 * @author vlse2610
 */
class OneToOneEntityHydratorTest_sVysvetlivkou extends TestCase {    
    ...
    public function testOneToOneHydrate() : void {      
        ...
        $oneToOneEntityHydrator = new OneToOneAccessorHydrator( new MethodNameHydrator_forOOHT(),
