 ...
 * 
 */
class OneToOneAccessorHydrator implements AccessorHydratorInterface {
    /**
     *
...
//        foreach (get_object_vars($key) as $nameAttr->$value) {            
//            $identity->$nameAttr = $value;
//        }        
//        //ale identita nema public vlastnosti - tak toto nejde delat odsad, si myslim        
//    }       
//    public function extract(  IdentityInterface $identity, KeyInterface $key ): void {         
//        foreach (get_object_vars($identity) as $nameAttr->$value) {            
//            $key->$nameAttr = $value;
//        }
//    }
